...
var fancyCanvas = require('fancy-canvas');
...
})(exports.LineStyle || (exports.LineStyle = {}));
...
})(exports.CrosshairMode || (exports.CrosshairMode = {}));
 ...
 */
exports.MismatchDirection = void 0;
...
})(exports.MismatchDirection || (exports.MismatchDirection = {}));
...
})(exports.PriceScaleMode || (exports.PriceScaleMode = {}));
 ...
 */
exports.TrackingModeExitMode = void 0;
...
})(exports.TrackingModeExitMode || (exports.TrackingModeExitMode = {}));
class ChartModel {
 ...
 */
exports.LastPriceAnimationMode = void 0;
...
})(exports.LastPriceAnimationMode || (exports.LastPriceAnimationMode = {}));
 ...
 */
exports.PriceLineSource = void 0;
...
})(exports.PriceLineSource || (exports.PriceLineSource = {}));
...
})(exports.TickMarkType || (exports.TickMarkType = {}));
...
function suggestChartSize(originalSize) {
    ...
    return fancyCanvas.size({ width, height });
}
...
function createBoundCanvas(parentElement, size) {
    ...
    const binding = fancyCanvas.bindCanvasElementBitmapSizeTo(canvas, {
...
class PriceAxisWidget {
    constructor(pane, options, rendererOptionsProvider, side) {
        ...
        this._private__canvasBinding = createBoundCanvas(this._private__cell, fancyCanvas.size({ width: 16, height: 16 }));
        ...
        canvas.style.left = '0';
        canvas.style.top = '0';
        this._private__topCanvasBinding = createBoundCanvas(this._private__cell, fancyCanvas.size({ width: 16, height: 16 }));
    ...
    _internal_setSize(newSize) {
        if (this._private__size === null || !fancyCanvas.equalSizes(this._private__size, newSize)) {
    ...
    _internal_paint(type) {
        ...
        if (type !== 1 /* InvalidationLevel.Cursor */) {
            ...
            const target = fancyCanvas.tryCreateCanvasRenderingTarget2D(this._private__canvasBinding);
            if (target !== null) {
        ...
        const topTarget = fancyCanvas.tryCreateCanvasRenderingTarget2D(this._private__topCanvasBinding);
        if (topTarget !== null) {
...
class PaneWidget {
    constructor(chart, state) {
        this._private__size = fancyCanvas.size({ width: 0, height: 0 });
        ...
        this._private__canvasBinding = createBoundCanvas(paneWrapper, fancyCanvas.size({ width: 16, height: 16 }));
        this._private__canvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__canvasSuggestedBitmapSizeChangedHandler);
        const canvas = this._private__canvasBinding.canvasElement;
        canvas.style.position = 'absolute';
        canvas.style.zIndex = '1';
        canvas.style.left = '0';
        canvas.style.top = '0';
        this._private__topCanvasBinding = createBoundCanvas(paneWrapper, fancyCanvas.size({ width: 16, height: 16 }));
        this._private__topCanvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__topCanvasSuggestedBitmapSizeChangedHandler);
        const topCanvas = this._private__topCanvasBinding.canvasElement;
        topCanvas.style.position = 'absolute';
        topCanvas.style.zIndex = '2';
    ...
    _internal_setPriceAxisSize(width, position) {
        ...
        ensureNotNull(priceAxisWidget)._internal_setSize(fancyCanvas.size({ width, height: this._private__size.height }));
    }
    _internal_getSize() {
        return this._private__size;
    }
    _internal_setSize(newSize) {
        if (fancyCanvas.equalSizes(this._private__size, newSize)) {
            return;
        }
        this._private__size = newSize;
        this._private__isSettingSize = true;
...
class TimeAxisWidget {
    constructor(chartWidget, horzScaleBehavior) {
        ...
        this._private__canvasBinding = createBoundCanvas(this._private__dv, fancyCanvas.size({ width: 16, height: 16 }));
        this._private__canvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__canvasSuggestedBitmapSizeChangedHandler);
        const canvas = this._private__canvasBinding.canvasElement;
        canvas.style.position = 'absolute';
        canvas.style.zIndex = '1';
        canvas.style.left = '0';
        canvas.style.top = '0';
        this._private__topCanvasBinding = createBoundCanvas(this._private__dv, fancyCanvas.size({ width: 16, height: 16 }));
        this._private__topCanvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__topCanvasSuggestedBitmapSizeChangedHandler);
        const topCanvas = this._private__topCanvasBinding.canvasElement;
        topCanvas.style.position = 'absolute';
        topCanvas.style.zIndex = '2';
    ...
    _internal_setSizes(timeAxisSize, leftStubWidth, rightStubWidth) {
        if (!fancyCanvas.equalSizes(this._private__size, timeAxisSize)) {
        ...
        if (this._private__leftStub !== null) {
            this._private__leftStub._internal_setSize(fancyCanvas.size({ width: leftStubWidth, height: timeAxisSize.height }));
        }
        if (this._private__rightStub !== null) {
            this._private__rightStub._internal_setSize(fancyCanvas.size({ width: rightStubWidth, height: timeAxisSize.height }));
        }
    }
...
class ChartWidget {
    ...
    _internal_resize(width, height, forceRepaint = false) {
        ...
        const sizeHint = suggestChartSize(fancyCanvas.size({ width, height }));
    ...
    _private__adjustSizeImpl() {
        ...
        for (let paneIndex = 0; paneIndex < this._private__paneWidgets.length; ++paneIndex) {
            ...
            paneWidget._internal_setSize(fancyCanvas.size({ width: paneWidth, height: paneHeight }));
            if (this._private__isLeftAxisVisible()) {
        ...
        this._private__timeAxisWidget._internal_setSizes(fancyCanvas.size({ width: timeAxisVisible ? paneWidth : 0, height: timeAxisHeight }), timeAxisVisible ? leftPriceAxisWidth : 0, timeAxisVisible ? rightPriceAxisWidth : 0);
...
exports.customSeriesDefaultOptions = customSeriesDefaultOptions;
exports.defaultHorzScaleBehavior = defaultHorzScaleBehavior;
